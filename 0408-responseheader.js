// Filename: 0408-responseheader.js
// Course: Dicoding- Back End Basics
// Description: Module 0408 Membangun Web Service menggunakan Node.js- Response header
...
// Test HTTP server status on port 5000 with method, route 'about' and payloads- returns API status and header
// Web `http://{{IP_ADDRESS}}:5000/about`
// Postman [GET/POST/PUT/PATCH/DELETE] `http://{{IP_ADDRESS}}:5000/about`		// Postman 0408-responseheader
